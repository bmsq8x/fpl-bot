...
# ---------------------------------------------------------
# 3. توجيهات الذكاء الاصطناعي والاستراتيجيات الشاملة
# ---------------------------------------------------------
SYSTEM_PROMPT = """
...
# ---------------------------------------------------------
# 4. واجهة العرض الرئيسية في صفحة واحدة
# ---------------------------------------------------------
st.markdown(
...
# شريط إدخال معرف الفريق والديدلاين في الأعلى
...
# ---------------------------------------------------------
# 5. نظام التبويبات المتكامل (جميع الأقسام بدون شريط جانبي)
# ---------------------------------------------------------
